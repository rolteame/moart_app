...
<template>
	<AlertDialog>
		...
		>
			<span class="font-xs px-2">View Matured Investments</span>
		</AlertDialogTrigger>
		<AlertDialogContent class="py-2 text-xl">
			...
			<AlertDialogHeader>
				<AlertDialogTitle class="text-sm px-2"
					>Matured Investment Details</AlertDialogTitle
				>
				<Separator />
				<AlertDialogDescription>
					<div class="overflow-y-auto h-[70vh]">
						<div
							...
							v-if="userInvestments?.results?.length > 0"
						>
							<p>
								Property Name:
						...
						<div
							...
							v-else
						>
							<p class="text-lg font-semibold">No Matured Investments</p>
						</div>
					</div>
